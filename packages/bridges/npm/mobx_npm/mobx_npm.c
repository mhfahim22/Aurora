/* Auto-generated QuickJS npm bridge DLL for mobx */
#define _GNU_SOURCE
...
static JSValue load_module(JSContext*ctx,const char*path,const char*name){
  ...
  if(strlen(path)>4&&strcmp(path+strlen(path)-4,".mjs")==0){
    ...
    if(cjs_f){
      ...
      fread(code,1,len,cjs_f);code[len]=0;fclose(cjs_f);
    }else{
...
EXPORT void mobx_free_cstr(void*s){if(s)free(s);}
EXPORT char* mobx_get_last_error(void){return g_last_error;}

EXPORT void* mobx_str(const char*s){
...
EXPORT void* mobx_list2(void*a,void*b){return mobx_tuple2(a,b);}
EXPORT void* mobx_list3(void*a,void*b,void*c){return mobx_tuple3(a,b,c);}
EXPORT void* mobx_list4(void*a,void*b,void*c,void*d){return mobx_tuple4(a,b,c,d);}
EXPORT void* mobx_list(void**items,int count){return mobx_tuple(items,count);}
EXPORT void* mobx_dict(void){return store_json("{}");}
EXPORT int mobx_dict_set(void*d,const char*key,void*val){
...
EXPORT void* mobx_call6(void*mod,const char*fn,void*a,void*b,void*c,void*d,void*e,void*f){
...
EXPORT void* mobx_call_kw(void*mod,const char*fn,void*args,void*kwargs){
...
EXPORT void* mobx_getattr(void*obj,const char*name){
