/* Auto-generated QuickJS npm bridge DLL for moment */
#define _GNU_SOURCE
...
EXPORT void moment_free_cstr(void*s){if(s)free(s);}
EXPORT char* moment_get_last_error(void){return g_last_error;}
EXPORT const char* moment_get_perf_stats(void){
