/* Auto-generated QuickJS npm bridge DLL for uuid */
#define _GNU_SOURCE
...
EXPORT void uuid_free_cstr(void*s){if(s)free(s);}
EXPORT char* uuid_get_last_error(void){return g_last_error;}
EXPORT const char* uuid_get_perf_stats(void){
...
EXPORT void* uuid_str(const char*s){
...
EXPORT void* uuid_list2(void*a,void*b){return uuid_tuple2(a,b);}
EXPORT void* uuid_list3(void*a,void*b,void*c){return uuid_tuple3(a,b,c);}
EXPORT void* uuid_list4(void*a,void*b,void*c,void*d){return uuid_tuple4(a,b,c,d);}
EXPORT void* uuid_list(void**items,int count){return uuid_tuple(items,count);}
EXPORT void* uuid_dict(void){return store_json("{}");}
EXPORT int uuid_dict_set(void*d,const char*key,void*val){
...
EXPORT void* uuid_call6(void*mod,const char*fn,void*a,void*b,void*c,void*d,void*e,void*f){
...
EXPORT void* uuid_call_kw(void*mod,const char*fn,void*args,void*kwargs){
...
EXPORT void* uuid_getattr(void*obj,const char*name){
