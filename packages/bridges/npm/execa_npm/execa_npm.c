/* Auto-generated QuickJS npm bridge DLL for execa */
#define _GNU_SOURCE
...
EXPORT void execa_free_cstr(void*s){if(s)free(s);}
EXPORT char* execa_get_last_error(void){return g_last_error;}
EXPORT const char* execa_get_perf_stats(void){
...
EXPORT void* execa_str(const char*s){
...
EXPORT void* execa_list2(void*a,void*b){return execa_tuple2(a,b);}
EXPORT void* execa_list3(void*a,void*b,void*c){return execa_tuple3(a,b,c);}
EXPORT void* execa_list4(void*a,void*b,void*c,void*d){return execa_tuple4(a,b,c,d);}
EXPORT void* execa_list(void**items,int count){return execa_tuple(items,count);}
EXPORT void* execa_dict(void){return store_json("{}");}
EXPORT int execa_dict_set(void*d,const char*key,void*val){
...
EXPORT void* execa_call6(void*mod,const char*fn,void*a,void*b,void*c,void*d,void*e,void*f){
...
EXPORT void* execa_call_kw(void*mod,const char*fn,void*args,void*kwargs){
...
EXPORT void* execa_getattr(void*obj,const char*name){
