// Auto-generated Cargo bridge for bitflags@2.13.0
...
#[no_mangle]
pub extern "C" fn bitflags_import() -> *mut c_void {
    registry(); // ensure initialized
    store(serde_json::Value::Object(serde_json::Map::new()))
}

#[no_mangle]
pub extern "C" fn bitflags_free(ptr: *mut c_void) {
    if !ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn bitflags_free_cstr(ptr: *mut std::ffi::c_char) {
    if !ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn bitflags_str(s: *const std::ffi::c_char) -> *mut c_void {
    let s = unsafe { CStr::from_ptr(s) }.to_string_lossy().to_string();
    store(serde_json::Value::String(s))
}

#[no_mangle]
pub extern "C" fn bitflags_int(v: i64) -> *mut c_void {
    store(serde_json::Value::Number(v.into()))
}

#[no_mangle]
pub extern "C" fn bitflags_float(v: f64) -> *mut c_void {
    store(serde_json::Value::Number(
        serde_json::Number::from_f64(v).unwrap_or(serde_json::Number::from(0))))
}

#[no_mangle]
pub extern "C" fn bitflags_tuple(items: *mut *mut c_void, count: i32) -> *mut c_void {
...
#[no_mangle]
pub extern "C" fn bitflags_list(items: *mut *mut c_void, count: i32) -> *mut c_void {
    let mut vec = Vec::with_capacity(count as usize);
    for i in 0..count {
        let ptr = unsafe { *items.offset(i as isize) };
        if ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn bitflags_tuple2(a: *mut c_void, b: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
...
#[no_mangle]
pub extern "C" fn bitflags_tuple3(a: *mut c_void, b: *mut c_void, c: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
...
#[no_mangle]
pub extern "C" fn bitflags_tuple4(a: *mut c_void, b: *mut c_void, c: *mut c_void, d: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
        if c.is_null() { serde_json::Value::Null } else { unsafe { retrieve(c) }.clone() },
...
#[no_mangle]
pub extern "C" fn bitflags_list2(a: *mut c_void, b: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
    ]))
...
#[no_mangle]
pub extern "C" fn bitflags_list3(a: *mut c_void, b: *mut c_void, c: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
        if c.is_null() { serde_json::Value::Null } else { unsafe { retrieve(c) }.clone() },
...
#[no_mangle]
pub extern "C" fn bitflags_list4(a: *mut c_void, b: *mut c_void, c: *mut c_void, d: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
        if c.is_null() { serde_json::Value::Null } else { unsafe { retrieve(c) }.clone() },
...
#[no_mangle]
pub extern "C" fn bitflags_dict() -> *mut c_void {
    store(serde_json::Value::Object(serde_json::Map::new()))
}

#[no_mangle]
pub extern "C" fn bitflags_dict_set(d: *mut c_void, key: *const std::ffi::c_char, val: *mut c_void) -> i32 {
...
#[no_mangle]
pub extern "C" fn bitflags_to_cstr(obj: *mut c_void) -> *mut std::ffi::c_char {
...
#[no_mangle]
pub extern "C" fn bitflags_getattr(obj: *mut c_void, name: *const std::ffi::c_char) -> *mut c_void {
...
#[no_mangle]
pub extern "C" fn bitflags_call1(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
    a: *mut c_void,
) -> *mut c_void {
...
#[no_mangle]
pub extern "C" fn bitflags_call2(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn bitflags_call3(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn bitflags_call4(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn bitflags_call5(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn bitflags_call6(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn bitflags_call_kw(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
    args: *mut c_void,
    kwargs: *mut c_void,
...
#[no_mangle]
pub extern "C" fn bitflags_construct(
...
#[no_mangle]
pub extern "C" fn bitflags_call_method(
    handle: *mut c_void,
    type_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn bitflags_free_type(handle: *mut c_void, type_name: *const std::ffi::c_char) {
...
#[no_mangle]
pub extern "C" fn bitflags_last_error() -> *mut std::ffi::c_char {
    LAST_ERROR.with(|e| {
