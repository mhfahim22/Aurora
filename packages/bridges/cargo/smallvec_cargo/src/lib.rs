// Auto-generated Cargo bridge for smallvec@1.15.1
...
fn type_registry() -> &'static Mutex<HashMap<String, HashMap<String, MethodFn>>> {
    ...
    // ── IntoIter<[u8; 8]> methods ──
    {
        let tn = "IntoIter".to_string();
        let mut methods: HashMap<String, MethodFn> = HashMap::new();
        methods.insert("as_slice".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &*(this_ptr as *const smallvec::IntoIter<[u8; 8]>) };
            let __result = this_ref.as_slice();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("as_mut_slice".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::IntoIter<[u8; 8]>) };
            let __result = this_ref.as_mut_slice();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        type_map.insert(tn, methods);
    }
    // ── SmallVec<[u8; 8]> methods ──
    {
        let tn = "SmallVec".to_string();
        let mut methods: HashMap<String, MethodFn> = HashMap::new();
        methods.insert("inline_size".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &*(this_ptr as *const smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.inline_size();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        ...
        methods.insert("capacity".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &*(this_ptr as *const smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.capacity();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("spilled".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &*(this_ptr as *const smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.spilled();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("pop".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.pop();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("grow".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.grow(a0);
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("try_grow".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.try_grow(a0);
            match __result {
                Ok(v) => serde_json::to_value(&v).map_err(|e| e.to_string()),
                Err(e) => Err(e.to_string()),
            }
        });
        methods.insert("reserve".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.reserve(a0);
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("try_reserve".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.try_reserve(a0);
            match __result {
                Ok(v) => serde_json::to_value(&v).map_err(|e| e.to_string()),
                Err(e) => Err(e.to_string()),
            }
        });
        methods.insert("reserve_exact".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.reserve_exact(a0);
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("try_reserve_exact".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.try_reserve_exact(a0);
            match __result {
                Ok(v) => serde_json::to_value(&v).map_err(|e| e.to_string()),
                Err(e) => Err(e.to_string()),
            }
        });
        methods.insert("shrink_to_fit".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.shrink_to_fit();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("truncate".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.truncate(a0);
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("as_slice".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &*(this_ptr as *const smallvec::SmallVec<[u8; 8]>) };
        ...
        methods.insert("swap_remove".to_string(), |this_ptr: *mut c_void, args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __result = this_ref.swap_remove(a0);
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        ...
        methods.insert("dedup".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.dedup();
            serde_json::to_value(&__result).map_err(|e| e.to_string())
        });
        methods.insert("as_ptr".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &*(this_ptr as *const smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.as_ptr();
            Ok(serde_json::json!(__result as usize))
        });
        methods.insert("as_mut_ptr".to_string(), |this_ptr: *mut c_void, _args: Vec<serde_json::Value>| -> std::result::Result<serde_json::Value, String> {
            let this_ref = unsafe { &mut *(this_ptr as *mut smallvec::SmallVec<[u8; 8]>) };
            let __result = this_ref.as_mut_ptr();
            Ok(serde_json::json!(__result as usize))
        });
        type_map.insert(tn, methods);
    }
...
fn ctor_registry() -> &'static Mutex<HashMap<String, HashMap<String, CtorFn>>> {
    ...
    // ── SmallVec<[u8; 8]> constructors ──
    {
        ...
        ctors.insert("new".to_string(), |_args: Vec<serde_json::Value>| -> std::result::Result<*mut c_void, String> {
            let __val = smallvec::SmallVec::<[u8; 8]>::new();
        ...
        ctors.insert("with_capacity".to_string(), |args: Vec<serde_json::Value>| -> std::result::Result<*mut c_void, String> {
            let a0: serde_json::Value = args.get(0).ok_or_else(|| "0: missing arg".to_string())?.clone();
            let a0 = __deser(a0)?;
            let __val = smallvec::SmallVec::<[u8; 8]>::with_capacity(a0);
            Ok(Box::into_raw(Box::new(__val)) as *mut c_void)
        });
...
fn drop_registry() -> &'static Mutex<HashMap<String, DropFn>> {
    ...
    m.insert("IntoIter".to_string(), {
        let f: DropFn = |ptr| unsafe { drop(Box::from_raw(ptr as *mut smallvec::IntoIter<[u8; 8]>)); };
        f
    });
    m.insert("SmallVec".to_string(), {
        let f: DropFn = |ptr| unsafe { drop(Box::from_raw(ptr as *mut smallvec::SmallVec<[u8; 8]>)); };
        f
    });
        Mutex::new(m)
    })
...
#[no_mangle]
pub extern "C" fn smallvec_import() -> *mut c_void {
    registry(); // ensure initialized
    store(serde_json::Value::Object(serde_json::Map::new()))
}

#[no_mangle]
pub extern "C" fn smallvec_free(ptr: *mut c_void) {
    if !ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn smallvec_free_cstr(ptr: *mut std::ffi::c_char) {
    if !ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn smallvec_str(s: *const std::ffi::c_char) -> *mut c_void {
    let s = unsafe { CStr::from_ptr(s) }.to_string_lossy().to_string();
    store(serde_json::Value::String(s))
}

#[no_mangle]
pub extern "C" fn smallvec_int(v: i64) -> *mut c_void {
    store(serde_json::Value::Number(v.into()))
}

#[no_mangle]
pub extern "C" fn smallvec_float(v: f64) -> *mut c_void {
    store(serde_json::Value::Number(
        serde_json::Number::from_f64(v).unwrap_or(serde_json::Number::from(0))))
}

#[no_mangle]
pub extern "C" fn smallvec_tuple(items: *mut *mut c_void, count: i32) -> *mut c_void {
...
#[no_mangle]
pub extern "C" fn smallvec_list(items: *mut *mut c_void, count: i32) -> *mut c_void {
    let mut vec = Vec::with_capacity(count as usize);
    for i in 0..count {
        let ptr = unsafe { *items.offset(i as isize) };
        if ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn smallvec_tuple2(a: *mut c_void, b: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
...
#[no_mangle]
pub extern "C" fn smallvec_tuple3(a: *mut c_void, b: *mut c_void, c: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
...
#[no_mangle]
pub extern "C" fn smallvec_tuple4(a: *mut c_void, b: *mut c_void, c: *mut c_void, d: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
        if c.is_null() { serde_json::Value::Null } else { unsafe { retrieve(c) }.clone() },
...
#[no_mangle]
pub extern "C" fn smallvec_list2(a: *mut c_void, b: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
    ]))
...
#[no_mangle]
pub extern "C" fn smallvec_list3(a: *mut c_void, b: *mut c_void, c: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
        if c.is_null() { serde_json::Value::Null } else { unsafe { retrieve(c) }.clone() },
...
#[no_mangle]
pub extern "C" fn smallvec_list4(a: *mut c_void, b: *mut c_void, c: *mut c_void, d: *mut c_void) -> *mut c_void {
    store(serde_json::Value::Array(vec![
        if a.is_null() { serde_json::Value::Null } else { unsafe { retrieve(a) }.clone() },
        if b.is_null() { serde_json::Value::Null } else { unsafe { retrieve(b) }.clone() },
        if c.is_null() { serde_json::Value::Null } else { unsafe { retrieve(c) }.clone() },
...
#[no_mangle]
pub extern "C" fn smallvec_dict() -> *mut c_void {
    store(serde_json::Value::Object(serde_json::Map::new()))
}

#[no_mangle]
pub extern "C" fn smallvec_dict_set(d: *mut c_void, key: *const std::ffi::c_char, val: *mut c_void) -> i32 {
...
#[no_mangle]
pub extern "C" fn smallvec_to_cstr(obj: *mut c_void) -> *mut std::ffi::c_char {
...
#[no_mangle]
pub extern "C" fn smallvec_getattr(obj: *mut c_void, name: *const std::ffi::c_char) -> *mut c_void {
...
#[no_mangle]
pub extern "C" fn smallvec_call1(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
    a: *mut c_void,
) -> *mut c_void {
...
#[no_mangle]
pub extern "C" fn smallvec_call2(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn smallvec_call3(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn smallvec_call4(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn smallvec_call5(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn smallvec_call6(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn smallvec_call_kw(
    _handle: *mut c_void,
    fn_name: *const std::ffi::c_char,
    args: *mut c_void,
    kwargs: *mut c_void,
...
#[no_mangle]
pub extern "C" fn smallvec_construct(
...
#[no_mangle]
pub extern "C" fn smallvec_call_method(
    handle: *mut c_void,
    type_name: *const std::ffi::c_char,
...
#[no_mangle]
pub extern "C" fn smallvec_free_type(handle: *mut c_void, type_name: *const std::ffi::c_char) {
...
#[no_mangle]
pub extern "C" fn smallvec_last_error() -> *mut std::ffi::c_char {
    LAST_ERROR.with(|e| {
