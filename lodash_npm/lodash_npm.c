/* Auto-generated QuickJS npm bridge DLL for lodash */
#define _GNU_SOURCE
...
EXPORT void* lodash_require(void){
  if(!g_inited&&!init_qjs("lodash_npm"))return NULL;
  if(g_ctx&&!g_loaded){
    for(int i=0;i<MAX_OBJS;i++)g_objs[i]=JS_NULL;
    JSValue g=JS_GetGlobalObject(g_ctx);
    JSValue rv=JS_GetPropertyStr(g_ctx,g,"require");
    if(JS_IsFunction(g_ctx,rv)){
      JSValue nm=JS_NewString(g_ctx,"lodash");
...
EXPORT void lodash_free(void*h){
...
EXPORT void lodash_free_cstr(void*s){if(s)free(s);}
EXPORT char* lodash_get_last_error(void){return g_last_error;}
EXPORT const char* lodash_get_perf_stats(void){
...
EXPORT void* lodash_str(const char*s){
...
EXPORT void* lodash_list2(void*a,void*b){return lodash_tuple2(a,b);}
EXPORT void* lodash_list3(void*a,void*b,void*c){return lodash_tuple3(a,b,c);}
EXPORT void* lodash_list4(void*a,void*b,void*c,void*d){return lodash_tuple4(a,b,c,d);}
EXPORT void* lodash_list(void**items,int count){return lodash_tuple(items,count);}
EXPORT void* lodash_dict(void){return store_json("{}");}
EXPORT int lodash_dict_set(void*d,const char*key,void*val){
...
EXPORT void* lodash_call6(void*mod,const char*fn,void*a,void*b,void*c,void*d,void*e,void*f){
...
EXPORT void* lodash_call_kw(void*mod,const char*fn,void*args,void*kwargs){
...
EXPORT void* lodash_getattr(void*obj,const char*name){
