/* Auto-generated QuickJS npm bridge DLL for chalk */
#define _GNU_SOURCE
...
EXPORT void chalk_free_cstr(void*s){if(s)free(s);}
EXPORT char* chalk_get_last_error(void){return g_last_error;}
EXPORT const char* chalk_get_perf_stats(void){
...
EXPORT void* chalk_str(const char*s){
...
EXPORT void* chalk_list2(void*a,void*b){return chalk_tuple2(a,b);}
EXPORT void* chalk_list3(void*a,void*b,void*c){return chalk_tuple3(a,b,c);}
EXPORT void* chalk_list4(void*a,void*b,void*c,void*d){return chalk_tuple4(a,b,c,d);}
EXPORT void* chalk_list(void**items,int count){return chalk_tuple(items,count);}
EXPORT void* chalk_dict(void){return store_json("{}");}
EXPORT int chalk_dict_set(void*d,const char*key,void*val){
...
EXPORT void* chalk_call6(void*mod,const char*fn,void*a,void*b,void*c,void*d,void*e,void*f){
...
EXPORT void* chalk_call_kw(void*mod,const char*fn,void*args,void*kwargs){
...
EXPORT void* chalk_getattr(void*obj,const char*name){
